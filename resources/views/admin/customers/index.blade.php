        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5" id="customerGrid">
                @forelse ($customers as $customer)
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 customer-card"
                        data-name="{{ strtolower($customer->nama_lengkap) }}"
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900">{{ $customer->nama_lengkap }}</p>
