<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Edit Spare Part — {{ $sparePart->nama }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-8 shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.spare-parts.update', $sparePart) }}" method="POST" class="space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <x-text-input id="kode" name="kode" type="text" class="block mt-1 w-full"
                            :value="old('kode', $sparePart->kode)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="nama" name="nama" type="text" class="block mt-1 w-full"
                            :value="old('nama', $sparePart->nama)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="stok" name="stok" type="number" min="0"
                            class="block mt-1 w-full" :value="old('stok', $sparePart->stok)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="harga" name="harga" type="number" min="0"
                            class="block mt-1 w-full" :value="old('harga', $sparePart->harga)" required />
